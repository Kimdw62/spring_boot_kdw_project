...
//      boardService.get(2101);
//      boardService.del(2102);
...
<body>
	<table id="list-table" cellpadding="0" cellspacing="0" border="1">
	</table>
</body>
</html>